...
```sh
uv tool install "git+https://studio.wevr.com/wevr-public/cli-tester.git@v1.3.0"
```

For workstations that already have SSH set up to studio.wevr.com:

```sh
uv tool install "git+ssh://git@studio.wevr.com/wevr-public/cli-tester.git@v1.3.0"
```
